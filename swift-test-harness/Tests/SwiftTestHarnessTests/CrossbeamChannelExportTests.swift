...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `CrossbeamChannel.swiftmodule/`
...
//      `import CrossbeamChannel` above would fail at compile time.
//
//   2. The static archive `libCrossbeamChannel.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "CrossbeamChannel" }` and
//      `flattenPackage = "io.github.kotlinmania.crossbeamchannel"` configuration in
...
//      via the `CrossbeamChannelLibrary` product.
//
