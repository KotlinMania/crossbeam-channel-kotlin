...
This file is the quick-reference operating contract for crossbeam-channel-kotlin. The longer
...
crossbeam-channel-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`crossbeam-channel`](https://crates.io/crates/crossbeam-channel). Upstream Rust is the behavioral oracle while the
