...
//
// A fixed, non-sensitive stub value for PATH is provided so any browser-side
// `process.env.PATH` reads resolve to a safe placeholder without embedding
// real process-environment secrets.
//
